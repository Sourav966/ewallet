<?php
	...
	if(isset($_POST['add'])) {
		$amount = $_POST['amount'];
		if(trim($amount) == "0") {
			header('location:add.php?msg=Invalid amount');
		}
		if(!preg_match("/^[0-9.]*$/",trim($amount))) {
			header('location:add.php?msg=Invalid amount');
		}
...
<div class="row">
  ...
  <div class="col-25">
    <div class="container">
      ...
      <p><a href="#">Amount</a> <span class="price">&#8377;<?php echo $amount; ?></span></p>
      <hr>
      <p>Total <span class="price" style="color:black"><b>&#8377;<?php echo $amount; ?></b></span></p>
    </div>
  </div>
</div>
</body>
